-- The simplify-order-statuses migration introduced a 2-arg overload that
-- conflicts with the existing 3-arg submit_agent_order(uuid, jsonb, jsonb).
drop function if exists public.submit_agent_order(uuid, jsonb);
