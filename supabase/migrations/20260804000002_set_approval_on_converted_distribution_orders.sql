...
begin
  ...
  values (
    ...
    coalesce(source_order.submitted_by, acting_admin_id),
    acting_admin_id,
  ...
  set parent_order_id = inserted_agent_order_id,
      ...
      admin_read_at = coalesce(admin_read_at, conversion_timestamp),
      admin_read_by = coalesce(admin_read_by, acting_admin_id),
