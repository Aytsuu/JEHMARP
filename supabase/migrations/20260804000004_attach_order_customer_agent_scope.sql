...
drop function if exists public.list_admin_customer_rows(text, text, integer, integer, uuid, uuid[]);
drop function if exists public.list_admin_customer_rows(text, text, integer, integer, uuid, uuid[], boolean);
